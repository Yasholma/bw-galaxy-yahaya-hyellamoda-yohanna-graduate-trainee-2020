...
import io.byteworks.bwgalaxybackend.payload.ApiResponse;
import io.byteworks.bwgalaxybackend.payload.JwtAuthenticationResponse;
import io.byteworks.bwgalaxybackend.payload.LoginRequest;
import io.byteworks.bwgalaxybackend.payload.SignUpRequest;
...
import io.byteworks.bwgalaxybackend.security.JwtTokenProvider;
...
public class AuthController {
    ...
    public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest loginRequest, BindingResult bindingResult) {
        ...
        return ResponseEntity.ok(new JwtAuthenticationResponse(jwt, authentication.getAuthorities()));
    }
